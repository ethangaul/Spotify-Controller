...
SCOPE = "playlist-modify-public playlist-modify-private streaming user-read-playback-state user-modify-playback-state"
STATE = ""
...
def play():
    ...
    play_request = requests.put(play_endpoint, headers=authorization_header)
...
def next():
    ...
    next_profile_endpoint = "{}/me/player/next".format(SPOTIFY_API_URL)
    next_request = requests.post(next_profile_endpoint, headers=authorization_header)
